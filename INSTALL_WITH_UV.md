...
uv pip install path/to/olive-1.1.0-py3-none-any.whl
```
...
dependencies = [
    "olive @ git+ssh://git@github.com/YaVendio/olive.git@v1.1.0",
]
```
...
uv add git+ssh://git@github.com/YaVendio/olive.git@v1.1.0
